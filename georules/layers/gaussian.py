...
class GaussianLayer(Layer):
    ...
    def create_geology(self, poro_ave, perm_ave, poro_std, perm_std, ntg,
                       facies_filter=(2.5, 5, 2.5), sand_filter=(1.5, 2.5, 1.5),
        ...
        facies_filter : tuple of 3 floats
            Gaussian filter sigmas (x, y, z) for facies field.
        sand_filter : tuple of 3 floats
            Gaussian filter sigmas (x, y, z) for property field.
        nugget : float
